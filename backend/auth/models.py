...
# Таблица связки пользователей и решенных задач (Many-to-Many)
...
class Puzzle(Base):
    ...
    id = Column(String, primary_key=True)  # Lichess PuzzleId
    fen = Column(String, nullable=False)
    moves = Column(String, nullable=False)  # UCI-ходы через пробел
